...
echo "Generating Go protobuf files from $PROTO_DIR"
...
# message into ./substraitpb/extensions). Remote plugin execution means no local
# protoc or protoc-gen-go is required.
buf generate
