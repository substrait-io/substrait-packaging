...
public:
  ...
  virtual std::any visitOr(SubstraitTypeParser::OrContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitMulDiv(SubstraitTypeParser::MulDivContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAddSub(SubstraitTypeParser::AddSubContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitComparison(SubstraitTypeParser::ComparisonContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAnd(SubstraitTypeParser::AndContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitEquality(SubstraitTypeParser::EqualityContext *ctx) override {
    return visitChildren(ctx);
  }
