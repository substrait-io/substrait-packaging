...
public:
   ...
   */
    ...
    virtual std::any visitStructArg(FuncTestCaseParser::StructArgContext *context) = 0;

    virtual std::any visitMapArg(FuncTestCaseParser::MapArgContext *context) = 0;

    virtual std::any visitUserDefinedArg(FuncTestCaseParser::UserDefinedArgContext *context) = 0;

    virtual std::any visitLambdaArg(FuncTestCaseParser::LambdaArgContext *context) = 0;

    virtual std::any visitFuncCallArg(FuncTestCaseParser::FuncCallArgContext *context) = 0;
    ...
    virtual std::any visitLiteralStruct(FuncTestCaseParser::LiteralStructContext *context) = 0;

    virtual std::any visitLiteralMap(FuncTestCaseParser::LiteralMapContext *context) = 0;

    virtual std::any visitMapEntry(FuncTestCaseParser::MapEntryContext *context) = 0;

    virtual std::any visitCompoundLiteral(FuncTestCaseParser::CompoundLiteralContext *context) = 0;
    ...
    virtual std::any visitUserDefinedType(FuncTestCaseParser::UserDefinedTypeContext *context) = 0;
    ...
    virtual std::any visitStructType(FuncTestCaseParser::StructTypeContext *context) = 0;

    virtual std::any visitMapType(FuncTestCaseParser::MapTypeContext *context) = 0;
