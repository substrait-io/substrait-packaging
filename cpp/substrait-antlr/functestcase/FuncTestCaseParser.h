...
public:
  ...
  enum {
    ...
    RuleListArg = 40, RuleStructArg = 41, RuleMapArg = 42, RuleLambdaArg = 43, 
    RuleEnumArg = 44, RuleLiteralList = 45, RuleLiteralStruct = 46, RuleLiteralMap = 47, 
    RuleMapEntry = 48, RuleCompoundLiteral = 49, RuleLiteralLambda = 50, 
    RuleLambdaParameters = 51, RuleLambdaBody = 52, RuleDataType = 53, RuleScalarType = 54, 
    RuleBooleanType = 55, RuleStringType = 56, RuleBinaryType = 57, RuleIntType = 58, 
    RuleFloatType = 59, RuleDateType = 60, RuleIntervalYearType = 61, RuleIntervalDayType = 62, 
    RuleIntervalCompoundType = 63, RuleFixedCharType = 64, RuleVarCharType = 65, 
    RuleFixedBinaryType = 66, RuleDecimalType = 67, RulePrecisionTimeType = 68, 
    RulePrecisionTimestampType = 69, RulePrecisionTimestampTZType = 70, 
    RuleListType = 71, RuleStructType = 72, RuleMapType = 73, RuleFuncType = 74, 
    RuleFuncParameters = 75, RuleParameterizedType = 76, RuleNumericParameter = 77, 
    RuleSubstraitError = 78, RuleFuncOption = 79, RuleOptionName = 80, RuleOptionValue = 81, 
    RuleFuncOptions = 82, RuleNonReserved = 83, RuleIdentifier = 84
  };
