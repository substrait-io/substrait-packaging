...
public:
  ...
  enum {
    ...
    RuleListArg = 40, RuleStructArg = 41, RuleMapArg = 42, RuleUserDefinedArg = 43, 
    RuleLambdaArg = 44, RuleFuncCallArg = 45, RuleEnumArg = 46, RuleLiteralList = 47, 
    RuleLiteralStruct = 48, RuleLiteralMap = 49, RuleMapEntry = 50, RuleCompoundLiteral = 51, 
    RuleLiteralLambda = 52, RuleLambdaParameters = 53, RuleLambdaBody = 54, 
    RuleDataType = 55, RuleScalarType = 56, RuleUserDefinedType = 57, RuleBooleanType = 58, 
    RuleStringType = 59, RuleBinaryType = 60, RuleIntType = 61, RuleFloatType = 62, 
    RuleDateType = 63, RuleIntervalYearType = 64, RuleIntervalDayType = 65, 
    RuleIntervalCompoundType = 66, RuleFixedCharType = 67, RuleVarCharType = 68, 
    RuleFixedBinaryType = 69, RuleDecimalType = 70, RulePrecisionTimeType = 71, 
    RulePrecisionTimestampType = 72, RulePrecisionTimestampTZType = 73, 
    RuleListType = 74, RuleStructType = 75, RuleMapType = 76, RuleFuncType = 77, 
    RuleFuncParameters = 78, RuleParameterizedType = 79, RuleNumericParameter = 80, 
    RuleSubstraitError = 81, RuleFuncOption = 82, RuleOptionName = 83, RuleOptionValue = 84, 
    RuleFuncOptions = 85, RuleNonReserved = 86, RuleIdentifier = 87
  };
  ...
  class StructArgContext;
  class MapArgContext;
  class UserDefinedArgContext;
  class LambdaArgContext;
  class FuncCallArgContext;
  class EnumArgContext;
  class LiteralListContext;
  class LiteralStructContext;
  class LiteralMapContext;
  class MapEntryContext;
  class CompoundLiteralContext;
  ...
  public:
    ...
    StructArgContext *structArg();
    MapArgContext *mapArg();
    UserDefinedArgContext *userDefinedArg();
    LambdaArgContext *lambdaArg();
    FuncCallArgContext *funcCallArg();
  ...
  class  StructArgContext : public antlr4::ParserRuleContext {
  public:
    StructArgContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    LiteralStructContext *literalStruct();
    antlr4::tree::TerminalNode *DoubleColon();
  ...
  class  MapArgContext : public antlr4::ParserRuleContext {
  public:
    MapArgContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    LiteralMapContext *literalMap();
    antlr4::tree::TerminalNode *DoubleColon();
  ...
  class  UserDefinedArgContext : public antlr4::ParserRuleContext {
  public:
    UserDefinedArgContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    LiteralStructContext *literalStruct();
    antlr4::tree::TerminalNode *DoubleColon();
  ...
  class  FuncCallArgContext : public antlr4::ParserRuleContext {
  public:
    FuncCallArgContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IdentifierContext *identifier();
    antlr4::tree::TerminalNode *OParen();
    ArgumentsContext *arguments();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *OBracket();
    antlr4::tree::TerminalNode *CBracket();
    std::vector<CompoundLiteralContext *> compoundLiteral();
    CompoundLiteralContext* compoundLiteral(size_t i);
    std::vector<antlr4::tree::TerminalNode *> Comma();
    antlr4::tree::TerminalNode* Comma(size_t i);
  ...
  class  LiteralStructContext : public antlr4::ParserRuleContext {
  public:
    LiteralStructContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *OParen();
    antlr4::tree::TerminalNode *CParen();
    std::vector<CompoundLiteralContext *> compoundLiteral();
  ...
  class  LiteralMapContext : public antlr4::ParserRuleContext {
  public:
    LiteralMapContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    FuncTestCaseParser::CompoundLiteralContext *key = nullptr;
    FuncTestCaseParser::CompoundLiteralContext *value = nullptr;
  ...
  class  CompoundLiteralContext : public antlr4::ParserRuleContext {
  public:
    CompoundLiteralContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    LiteralContext *literal();
    LiteralListContext *literalList();
    LiteralStructContext *literalStruct();
  ...
  CompoundLiteralContext* compoundLiteral();
  ...
  public:
    antlr4::Token *isnull = nullptr;
    FuncTestCaseParser::DataTypeContext *keyType = nullptr;
    FuncTestCaseParser::DataTypeContext *valueType = nullptr;
