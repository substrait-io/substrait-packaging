...
public:
  ...
  virtual std::any visitStructArg(FuncTestCaseParser::StructArgContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMapArg(FuncTestCaseParser::MapArgContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitUserDefinedArg(FuncTestCaseParser::UserDefinedArgContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitFuncCallArg(FuncTestCaseParser::FuncCallArgContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitLiteralStruct(FuncTestCaseParser::LiteralStructContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLiteralMap(FuncTestCaseParser::LiteralMapContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMapEntry(FuncTestCaseParser::MapEntryContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCompoundLiteral(FuncTestCaseParser::CompoundLiteralContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitUserDefinedType(FuncTestCaseParser::UserDefinedTypeContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitStructType(FuncTestCaseParser::StructTypeContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMapType(FuncTestCaseParser::MapTypeContext *ctx) override {
    return visitChildren(ctx);
  }
