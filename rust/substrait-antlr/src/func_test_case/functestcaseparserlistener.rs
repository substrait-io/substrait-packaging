...
/**
 * Enter a parse tree produced by {@link FuncTestCaseParser#timeArg}.
 * @param ctx the parse tree
 */
fn enter_timeArg(&mut self, _ctx: &TimeArgContext<'input>) { }
/**
 * Exit a parse tree produced by {@link FuncTestCaseParser#timeArg}.
 * @param ctx the parse tree
 */
fn exit_timeArg(&mut self, _ctx: &TimeArgContext<'input>) { }
/**
 * Enter a parse tree produced by {@link FuncTestCaseParser#timestampArg}.
 * @param ctx the parse tree
 */
fn enter_timestampArg(&mut self, _ctx: &TimestampArgContext<'input>) { }
/**
 * Exit a parse tree produced by {@link FuncTestCaseParser#timestampArg}.
 * @param ctx the parse tree
 */
fn exit_timestampArg(&mut self, _ctx: &TimestampArgContext<'input>) { }
/**
 * Enter a parse tree produced by {@link FuncTestCaseParser#timestampTzArg}.
 * @param ctx the parse tree
 */
fn enter_timestampTzArg(&mut self, _ctx: &TimestampTzArgContext<'input>) { }
/**
 * Exit a parse tree produced by {@link FuncTestCaseParser#timestampTzArg}.
 * @param ctx the parse tree
 */
fn exit_timestampTzArg(&mut self, _ctx: &TimestampTzArgContext<'input>) { }
/**
...
/**
 * Enter a parse tree produced by {@link FuncTestCaseParser#timeType}.
 * @param ctx the parse tree
 */
fn enter_timeType(&mut self, _ctx: &TimeTypeContext<'input>) { }
/**
 * Exit a parse tree produced by {@link FuncTestCaseParser#timeType}.
 * @param ctx the parse tree
 */
fn exit_timeType(&mut self, _ctx: &TimeTypeContext<'input>) { }
/**
 * Enter a parse tree produced by {@link FuncTestCaseParser#timestampType}.
 * @param ctx the parse tree
 */
fn enter_timestampType(&mut self, _ctx: &TimestampTypeContext<'input>) { }
/**
 * Exit a parse tree produced by {@link FuncTestCaseParser#timestampType}.
 * @param ctx the parse tree
 */
fn exit_timestampType(&mut self, _ctx: &TimestampTypeContext<'input>) { }
/**
 * Enter a parse tree produced by {@link FuncTestCaseParser#timestampTZType}.
 * @param ctx the parse tree
 */
fn enter_timestampTZType(&mut self, _ctx: &TimestampTZTypeContext<'input>) { }
/**
 * Exit a parse tree produced by {@link FuncTestCaseParser#timestampTZType}.
 * @param ctx the parse tree
 */
fn exit_timestampTZType(&mut self, _ctx: &TimestampTZTypeContext<'input>) { }
/**
