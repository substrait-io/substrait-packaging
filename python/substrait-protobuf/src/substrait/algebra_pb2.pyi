...
class _FetchModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_FetchMode.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    FETCH_MODE_UNSPECIFIED: _FetchMode.ValueType  # 0
    """Unspecified. Producers must set one of the defined modes."""
    FETCH_MODE_ROWS_ONLY: _FetchMode.ValueType  # 1
    """Only return the requested number of rows."""
    FETCH_MODE_WITH_TIES: _FetchMode.ValueType  # 2
...
FETCH_MODE_UNSPECIFIED: FetchMode.ValueType  # 0
"""Unspecified. Producers must set one of the defined modes."""
FETCH_MODE_ROWS_ONLY: FetchMode.ValueType  # 1
"""Only return the requested number of rows."""
FETCH_MODE_WITH_TIES: FetchMode.ValueType  # 2
"""Include additional rows tied with the last row (per the sort fields)."""
Global___FetchMode: typing_extensions.TypeAlias = FetchMode
...
class RelCommon(google.protobuf.message.Message):
    ...
    ADVANCED_EXTENSION_FIELD_NUMBER: builtins.int
    REL_ANCHOR_FIELD_NUMBER: builtins.int
    rel_anchor: builtins.int
    ...
    def __init__(
        ...
        *,
        ...
        advanced_extension: substrait.extensions.extensions_pb2.AdvancedExtension | None = ...,
        rel_anchor: builtins.int | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_rel_anchor", b"_rel_anchor", "advanced_extension", b"advanced_extension", "direct", b"direct", "emit", b"emit", "emit_kind", b"emit_kind", "hint", b"hint", "rel_anchor", b"rel_anchor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_rel_anchor", b"_rel_anchor", "advanced_extension", b"advanced_extension", "direct", b"direct", "emit", b"emit", "emit_kind", b"emit_kind", "hint", b"hint", "rel_anchor", b"rel_anchor"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_rel_anchor", b"_rel_anchor"]) -> typing.Literal["rel_anchor"] | None: ...
    @typing.overload
...
class AggregateRel(google.protobuf.message.Message):
    ...
    class Grouping(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["expression_references", b"expression_references"]) -> None: ...
...
@typing.final
class TopNRel(google.protobuf.message.Message):
    ...
    ADVANCED_EXTENSION_FIELD_NUMBER: builtins.int
    mode: Global___FetchMode.ValueType
    ...
    @property
    def offset(self) -> Global___Expression:
    ...
    @property
    def count(self) -> Global___Expression:
        """Expression evaluating to a non-negative integer specifying the number of
    ...
    def __init__(
        ...
        *,
        ...
        input: Global___Rel | None = ...,
        sorts: collections.abc.Iterable[Global___SortField] | None = ...,
        offset: Global___Expression | None = ...,
        count: Global___Expression | None = ...,
        mode: Global___FetchMode.ValueType = ...,
        advanced_extension: substrait.extensions.extensions_pb2.AdvancedExtension | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["advanced_extension", b"advanced_extension", "common", b"common", "count", b"count", "input", b"input", "offset", b"offset"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["advanced_extension", b"advanced_extension", "common", b"common", "count", b"count", "input", b"input", "mode", b"mode", "offset", b"offset", "sorts", b"sorts"]) -> None: ...

Global___TopNRel: typing_extensions.TypeAlias = TopNRel
...
class Rel(google.protobuf.message.Message):
    ...
    @property
    def top_n(self) -> Global___TopNRel: ...
    def __init__(
        self,
        *,
...
class HashJoinRel(google.protobuf.message.Message):
    ...
    RESIDUAL_EXPRESSION_FIELD_NUMBER: builtins.int
    ADVANCED_EXTENSION_FIELD_NUMBER: builtins.int
    ...
    @property
    def residual_expression(self) -> Global___Expression:
    ...
    def __init__(
        ...
        *,
        ...
        type: Global___HashJoinRel.JoinType.ValueType = ...,
        build_input: Global___HashJoinRel.BuildInput.ValueType = ...,
        residual_expression: Global___Expression | None = ...,
        advanced_extension: substrait.extensions.extensions_pb2.AdvancedExtension | None = ...,
    ) -> None: ...
...
class Expression(google.protobuf.message.Message):
    ...
    class FieldReference(google.protobuf.message.Message):
        ...
        class OuterReference(google.protobuf.message.Message):
            ...
            REL_REFERENCE_FIELD_NUMBER: builtins.int
            ...
            def HasField(self, field_name: typing.Literal["outer_reference_type", b"outer_reference_type", "rel_reference", b"rel_reference", "steps_out", b"steps_out"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["outer_reference_type", b"outer_reference_type", "rel_reference", b"rel_reference", "steps_out", b"steps_out"]) -> None: ...
            def WhichOneof(self, oneof_group: typing.Literal["outer_reference_type", b"outer_reference_type"]) -> typing.Literal["steps_out", "rel_reference"] | None: ...
    ...
    @typing.final
    class ExecutionContextVariable(google.protobuf.message.Message):
        """Expression that represents execution context dependent variables.
        These are modeled as expressions rather than functions because they:
        - Take no input arguments
        - Depend on execution context rather than input data
        - Require evaluation mode control (see ExecutionBehavior in plan.proto)
        """

        DESCRIPTOR: google.protobuf.descriptor.Descriptor

        CURRENT_TIMESTAMP_FIELD_NUMBER: builtins.int
        CURRENT_TIMEZONE_FIELD_NUMBER: builtins.int
        CURRENT_DATE_FIELD_NUMBER: builtins.int
        @property
        def current_timestamp(self) -> substrait.type_pb2.Type.PrecisionTimestampTZ:
            """an execution context dependent variable containing the current
            timestamp in current_timezone
            nullability must be NULLABILITY_REQUIRED
            """

        @property
        def current_timezone(self) -> substrait.type_pb2.Type.String:
            """an execution context dependent variable containing the current
            session timezone as a string defined by IANA timezone database
            (https://www.iana.org/time-zones).
            nullability must be NULLABILITY_REQUIRED
            """

        @property
        def current_date(self) -> substrait.type_pb2.Type.Date:
            """an execution context dependent variable containing the current date
            nullability must be NULLABILITY_REQUIRED
            """
        ...
        def __init__(
            self,
            *,
            current_timestamp: substrait.type_pb2.Type.PrecisionTimestampTZ | None = ...,
            current_timezone: substrait.type_pb2.Type.String | None = ...,
            current_date: substrait.type_pb2.Type.Date | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["current_date", b"current_date", "current_timestamp", b"current_timestamp", "current_timezone", b"current_timezone", "execution_context_variable_type", b"execution_context_variable_type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["current_date", b"current_date", "current_timestamp", b"current_timestamp", "current_timezone", b"current_timezone", "execution_context_variable_type", b"execution_context_variable_type"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["execution_context_variable_type", b"execution_context_variable_type"]) -> typing.Literal["current_timestamp", "current_timezone", "current_date"] | None: ...
    ...
    @property
    def execution_context_variable(self) -> Global___Expression.ExecutionContextVariable: ...
    @property
    ...
    def HasField(self, field_name: typing.Literal["cast", b"cast", "dynamic_parameter", b"dynamic_parameter", "enum", b"enum", "execution_context_variable", b"execution_context_variable", "if_then", b"if_then", "lambda", b"lambda", "lambda_invocation", b"lambda_invocation", "literal", b"literal", "multi_or_list", b"multi_or_list", "nested", b"nested", "rex_type", b"rex_type", "scalar_function", b"scalar_function", "selection", b"selection", "singular_or_list", b"singular_or_list", "subquery", b"subquery", "switch_expression", b"switch_expression", "window_function", b"window_function"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cast", b"cast", "dynamic_parameter", b"dynamic_parameter", "enum", b"enum", "execution_context_variable", b"execution_context_variable", "if_then", b"if_then", "lambda", b"lambda", "lambda_invocation", b"lambda_invocation", "literal", b"literal", "multi_or_list", b"multi_or_list", "nested", b"nested", "rex_type", b"rex_type", "scalar_function", b"scalar_function", "selection", b"selection", "singular_or_list", b"singular_or_list", "subquery", b"subquery", "switch_expression", b"switch_expression", "window_function", b"window_function"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["rex_type", b"rex_type"]) -> typing.Literal["literal", "selection", "scalar_function", "window_function", "if_then", "switch_expression", "singular_or_list", "multi_or_list", "cast", "subquery", "nested", "dynamic_parameter", "lambda", "lambda_invocation", "execution_context_variable", "enum"] | None: ...
