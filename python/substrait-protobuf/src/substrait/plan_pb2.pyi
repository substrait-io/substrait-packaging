...
class Plan(google.protobuf.message.Message):
    ...
    EXECUTION_BEHAVIOR_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def execution_behavior(self) -> Global___ExecutionBehavior:
        """Execution behavior settings for this plan, required."""
    ...
    def __init__(
        ...
        *,
        ...
        execution_behavior: Global___ExecutionBehavior | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["advanced_extensions", b"advanced_extensions", "execution_behavior", b"execution_behavior", "version", b"version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["advanced_extensions", b"advanced_extensions", "execution_behavior", b"execution_behavior", "expected_type_urls", b"expected_type_urls", "extension_urns", b"extension_urns", "extensions", b"extensions", "parameter_bindings", b"parameter_bindings", "relations", b"relations", "type_aliases", b"type_aliases", "version", b"version"]) -> None: ...
...
@typing.final
class ExecutionBehavior(google.protobuf.message.Message):
    """ExecutionBehavior specifies the execution behavior for plan evaluation."""

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    class _VariableEvaluationMode:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType

    class _VariableEvaluationModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ExecutionBehavior._VariableEvaluationMode.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        VARIABLE_EVALUATION_MODE_UNSPECIFIED: ExecutionBehavior._VariableEvaluationMode.ValueType  # 0
        VARIABLE_EVALUATION_MODE_PER_PLAN: ExecutionBehavior._VariableEvaluationMode.ValueType  # 1
        """Variables are evaluated once per Substrait plan execution."""
        VARIABLE_EVALUATION_MODE_PER_RECORD: ExecutionBehavior._VariableEvaluationMode.ValueType  # 2
        """Variables are evaluated once per record during execution."""

    class VariableEvaluationMode(_VariableEvaluationMode, metaclass=_VariableEvaluationModeEnumTypeWrapper):
        """VariableEvaluationMode specifies the frequency and scope of execution
        context variable evaluation.
        """

    VARIABLE_EVALUATION_MODE_UNSPECIFIED: ExecutionBehavior.VariableEvaluationMode.ValueType  # 0
    VARIABLE_EVALUATION_MODE_PER_PLAN: ExecutionBehavior.VariableEvaluationMode.ValueType  # 1
    """Variables are evaluated once per Substrait plan execution."""
    VARIABLE_EVALUATION_MODE_PER_RECORD: ExecutionBehavior.VariableEvaluationMode.ValueType  # 2
    """Variables are evaluated once per record during execution."""

    VARIABLE_EVAL_MODE_FIELD_NUMBER: builtins.int
    variable_eval_mode: Global___ExecutionBehavior.VariableEvaluationMode.ValueType
    """Defines the scope of execution context variable evaluation during plan
    execution.
    """
    def __init__(
        self,
    ...
    def ClearField(self, field_name: typing.Literal["variable_eval_mode", b"variable_eval_mode"]) -> None: ...

Global___ExecutionBehavior: typing_extensions.TypeAlias = ExecutionBehavior
